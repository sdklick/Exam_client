...
const Exampage = () => {
  ...
  const serveresultdata = async (marksobtain) => {
    const response = await fetch(
      "https://exam-server-4pe7.onrender.com/api/resultdata",
      {
        method: "POST",
        headers: {
  ...
  const regisdatasubmit = async (e) => {
    ...
    const response = await fetch(
      "https://exam-server-4pe7.onrender.com/api/registration",
      {
        method: "POST",
        headers: {
          Accept: "application/json",
      ...
      {isregister == true ? (
        <div className="card text-center">
          <div className="card-header">
            Set by {quesdata.setpersonname} First click Save and Then Finish
            Exam
          </div>
          <div className="card-body">
            {/* Question Section */}
